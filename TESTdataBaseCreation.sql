...
CREATE TABLE IF NOT EXISTS ventaProductos(
	id INT NOT NULL AUTO_INCREMENT,
	venta_producto_ref_key INT NOT NULL,
...
ALTER TABLE stockTest.ventaproductos ADD INDEX fk_venta_producto_ref (venta_producto_ref_key);
CREATE TABLE IF NOT EXISTS ventasTotal(
	id INT NOT NULL AUTO_INCREMENT,
    user_id INT NOT NULL,
    venta_producto_ref INT NOT NULL,
    sucursal_id INT NOT NULL,
    fecha DATE NOT NULL,
